...
import static com.saucedemo.helpers.MensajesValidacion.mensajeValidacionPaginaProductos;
...
public class ProductoStepDefinition {
    ...
    public void seDebeVerLaPaginaConLosDetallesDelProducto() {
        ...
        theActorInTheSpotlight().should(
                seeThat("Valida que se muestre la pagina detalle del producto", ValidarTexto.onValidar(LBL_PAGINA_DETALLE_PRODUCTO_VALIDACION), equalTo(mensajeValidacionPaginaProductos)),
